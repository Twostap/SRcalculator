...
def recordsdata():
    if request.method == "POST":
       ...
       GreyLiteratureAverage = df.query('Medline - @TotalMedline <= 99 & Medline - @TotalMedline > -99 & Topics.str.contains(@Topics) & `Other sources searched` == @GreyLiteratureSelection')['Grey Literature'].mean(numeric_only=True)
